int scg_make_sphere (int *pnV, int *pnF, double *Vertex, int *Index, double x, double meshsize, int nnV, int nnF);
int scg_make_paral (int *pnV, int *pnF, double *Vertex, int *Index, double x, double y, double z, double meshsize, int nnV, int nnF);
int scg_make_cylinder (int *pnV, int *pnF, double *Vertex, int *Index, double r, double h, double meshsize, int nnV, int nnF);
