...
extern "C" int scg_make_sphere (int *pnV, int *pnF, double *Vertex, int *Index, double x, double MS, int nnV, int nnF)
{
	int nnE = 10, nnS = 10;
...
nL++;
extern "C" int scg_make_paral (int *pnV, int *pnF, double *Vertex, int *Index, double x, double y, double z, double MS, int nnV, int nnF)
{
	const int nnL = 10, nnE = 10;
	int nE[nnL];
	int *edge[nnL], c1[nnL];
	int *face = 0, *facematerial = 0;
	double *vertex = 0;
	...
	*pnV += 8;
	...
	set_surface_size_function(fsize);
	// Making surface mesh
	polyhedron_make_front(pnV, vertex, nL, nE, edge, c1, 0, pnF, face, facematerial, nnV, nnF);
...
// Under construction;
extern "C" int scg_make_cylinder (int *pnV, int *pnF, double *Vertex, int *Index, double r, double h, double MS, int nnV, int nnF)
{
	int nnE = 10, nnS = 10;
	int *face = 0, *facematerial = 0;
	double *vertex = 0;
...
extern "C" int scg_read_front (int *pnV, int *pnF, double *Vertex, int *Index, char *file, int if_color)
{
    FILE *f;
    int i;
...
extern "C" int scg_write_front (int nV, int nF, double *Vertex, int *Index, char *file)
{
    FILE *f;
    int i, c = 0;
...
extern "C" int scg_write_front_gmv (int nV, int nF, double *vertex, int *face, char *file)
{
	int i;
	FILE *f;
...
extern "C" int scg_translate (int nV, double *Vertex, double x, double y, double z)
{
    int i;
...
extern "C" int scg_rotate (int nV, double *Vertex, double rot_x, double rot_y, double rot_z)
{
    int i;
...
extern "C" int scg_scale (int nV, double *Vertex, double s_x, double s_y, double s_z)
{
    int i;
...
extern "C" int scg_affine (int nV, double *Vertex, double *matrix)
{
    int i;
    double v1, v2, v3;
