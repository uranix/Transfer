/* dsterf.f -- translated by f2c (version 20090411).
...
L10:
    ...
    i__1 = *n - 1;
    for (m = l1; m <= i__1; ++m) {
	if ((d__3 = e[m], dabs(d__3)) <= sqrt((d__1 = d__[m], dabs(d__1))) * 
		sqrt((d__2 = d__[m + 1], dabs(d__2))) * eps) {
	    e[m] = 0.;
	    goto L30;
	}
/* L20: */
...
/*     Choose between QL and QR iteration */
    ...
    if ((d__1 = d__[lend], dabs(d__1)) < (d__2 = d__[l], dabs(d__2))) {
	lend = lsv;
	l = lendsv;
    }
...
L50:
	if (l != lend) {
	    i__1 = lend - 1;
	    for (m = l; m <= i__1; ++m) {
		if ((d__2 = e[m], dabs(d__2)) <= eps2 * (d__1 = d__[m] * d__[m 
			+ 1], dabs(d__1))) {
		    goto L70;
		}
/* L60: */
...
L100:
	i__1 = lend + 1;
	for (m = l; m >= i__1; --m) {
	    if ((d__2 = e[m - 1], dabs(d__2)) <= eps2 * (d__1 = d__[m] * d__[m 
		    - 1], dabs(d__1))) {
		goto L120;
	    }
/* L110: */
